...
const SAMPLE_VERSION = [
  ...
  {
    versionNumber: "v2.0.10",
    description:
      "Bugfix: Behebung kleinerer Tabellenprobleme im Bereich Items. Sortierung für Tags deaktiviert (Many-Relation nicht sortierbar). Allgemeine Verbesserung der persistierten Speicherung von Filtern und Mehrfach-Sortierungen.",
  },
];
