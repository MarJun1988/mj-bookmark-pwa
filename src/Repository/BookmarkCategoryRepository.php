...
/**
 * @extends ServiceEntityRepository<BookmarkCategory>
 *
 * @method BookmarkCategory|null find($id, $lockMode = null, $lockVersion = null)
 * @method BookmarkCategory|null findOneBy(array $criteria, array $orderBy = null)
 * @method BookmarkCategory[]    findAll()
 * @method BookmarkCategory[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class BookmarkCategoryRepository extends ServiceEntityRepository
{
     ...
     * @return BookmarkCategory[] Returns an array of General objects
    ...
    public function findByDataTableService(Request $requestUri, DataTableService $dataTableService, array $params): array
    {
        ...
        $joinTableTwo = "b";
        $globalFilter = [
            "$tableShort.tabArea", "$tableShort.designation", "$tableShort.comment",
            "$joinTableOne.designation", "$joinTableOne.comment",
            "$joinTableTwo.hyperlinkUrl", "$joinTableTwo.hyperlinkDescription", "$joinTableTwo.comment"
        ];
        ...
        if ($uri && str_contains($uri, '?') && !str_contains($uri, '?{}')) {
            ...
            $sql = $this->createQueryBuilder($tableShort)
                ->leftJoin("$tableShort.tabArea", $joinTableOne)
