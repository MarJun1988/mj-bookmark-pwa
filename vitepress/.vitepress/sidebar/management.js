    ...
    items: [
      {
        ...
        items: [
          {
            text: "Übersicht",
            link: "/management-area/ground-setting/overview",
          },
      ...
      {
        text: "Alarmierungen",
        link: "/management-area/incoming-alert/",
        items: [
          {
            text: "Übersicht",
            link: "/management-area/incoming-alert/overview",
          },
      ...
      {
        text: "Icons-Mitteilungen",
        link: "/management-area/message-icon/",
        items: [
      ...
      {
        text: "Darstellung (CSS)",
        link: "/management-area/site-style/",
        items: [
