      ...
      <template #content>
        <form class="space-y-6" @submit.prevent="submit">
          ...
          <div class="text-center space-y-1">
            ...
            <p v-if="success" class="text-sm text-surface-500">
              Dein Konto wurde erfolgreich aktiviert. Du kannst dich jetzt anmelden. Weiterleitung
              erfolgt in 3 Sekunden.
            </p>
          ...
          <div class="flex justify-end col-span-2">
            <Button label="Zur Anmeldung" link @click="router.push('/login')" />
          </div>
