...
const { mutate: requestDataExport, loading: loadingExport } =
  useMutation(REQUEST_DATA_EXPORT);
...
<template>
  <div class="space-y-4 grid grid-cols-2 gap-2">
    ...
    <p class="mb-3 col-span-2">
      Gemäß <b>Art. 15 DSGVO</b> hast du das Recht, Auskunft über die zu deiner
      Person gespeicherten Daten zu erhalten. Du kannst jederzeit eine Kopie
      deiner bei uns gespeicherten Daten anfordern.
    </p>

    <p class="mb-3 col-span-2">
      Der Export enthält alle Inhalte deines Kontos, darunter:
    </p>
    ...
    <p class="mt-3 text-sm col-span-2">
      Die Daten werden dir in strukturierter Form (JSON) bereitgestellt.
      Passwörter, Tokens oder andere sicherheitsrelevante Informationen sind
      nicht Bestandteil des Exports.
    </p>
    ...
    <Message
      ...
      severity="info"
    >
      Die Anforderung deiner Daten ist kostenlos und hat keine Auswirkungen auf
      dein Konto.
    </Message>
