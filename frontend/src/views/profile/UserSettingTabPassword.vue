...
<template>
  <div class="space-y-4 grid grid-cols-2 gap-2">
    <span class="font-semibold text-3xl text-center col-span-2"> Kennwort ändern </span>
    <p class="col-span-2 mb-4">
      Aus Sicherheitsgründen empfehlen wir, dein Kennwort regelmäßig zu ändern und ein starkes,
