...
const { mutate: deleteAccount, loading: loadingDeleteAccount } =
...
<template>
  <div class="space-y-4 grid grid-cols-2 gap-2">
    ...
    <p class="mb-3 col-span-2">
      Wenn du dein Konto löschst, werden alle zugehörigen Daten dauerhaft
      entfernt. Dazu zählen insbesondere:
    </p>
    ...
    <p class="mt-3 text-sm col-span-1">
      Wenn du deine Daten sichern möchtest, empfehlen wir dir, vor der Löschung
      zunächst den Datenexport zu nutzen.
    </p>
    <Message
      class="col-span-2"
