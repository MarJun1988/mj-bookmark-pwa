...
<template>
  ...
  <!--    </div>-->
  <!--  </div>-->
  <div :class="props.widthClass" class="m-auto my-4 px-5 mt-1 flex items-center">
    <!-- Links -->
    <div class="text-sm gap-2 flex items-center">
      <i class="pi pi-question-circle" />
      <a href="/help" target="_blank">Zur Hilfe</a>
    </div>

    <!-- Rechts -->
    <div class="flex items-center gap-2 text-sm ml-auto">
      <i class="pi pi-github" />
      <a href="https://github.com/MarJun1988/mj-bookmark-pwa" target="_blank"> Github </a>
      <span>|</span>
      <a href="https://github.com/MarJun1988/mj-bookmark-pwa/releases" target="_blank">
        <span v-if="props.showProjectName" class="hidden md:inline-block"> MJ-Bookmark-PWA </span>
        {{ lastVersion?.versionNumber }}
      </a>
    </div>
  </div>
