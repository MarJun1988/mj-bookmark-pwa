...
function isSkeletonItem(
  item: ItemView,
): item is Extract<ItemView, { __skeleton: true }> {
...
<template>
  ...
  >
    ...
    <div
      ...
      class="w-full flex flex-wrap gap-1 mt-3 text-xs col-span-2"
    >
    ...
    <div
      v-if="realItem?.tags"
      class="mt-auto pt-2 flex flex-wrap gap-1 col-span-2"
    >
      <Tag
